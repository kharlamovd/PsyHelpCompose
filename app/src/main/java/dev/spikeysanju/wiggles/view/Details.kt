...
import dev.spikeysanju.wiggles.component.DoсtorInfoCard
import dev.spikeysanju.wiggles.component.InfoCard
import dev.spikeysanju.wiggles.data.FakeDoctorDatabase
...
fun DetailsView(id: Int) {
    LazyColumn(
        ...
        val dog = FakeDoctorDatabase.doctorList[id]
        ...
        item {
            dog.apply {
                ...
                DoсtorInfoCard(name, gender, location)
            }
        }
        ...
        item {
            dog.apply {
                ...
                Row(
                    ...
                    InfoCard(title = "Возраст", value = dog.age.toString()/*.plus(" yrs")*/)
                    InfoCard(title = "Опыт", value = color)
        ...
        item {
            ...
            Button(
                ...
                Text("Записаться", fontSize = 18.sp/*, font = "Calibri"*/)
            }
            Spacer(modifier = Modifier.height(24.dp))
        }
    }
